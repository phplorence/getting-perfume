                        ...
                        <div class="col-2 col-md-4 col-sm-6 col-xs-12">
                            <div class="footer-widget instragram">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/1.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/2.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/3.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/4.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/5.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/6.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/7.jpg') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('img/instragram/8.jpg') }}" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
