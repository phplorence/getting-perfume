<div class="modal fade" id="concentrationModalCreate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="box-title" style="margin-top: -2px;" id="exampleModalLabel">THÊM MỚI</h3>
                <form id="concentrationFormCreate">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên nồng độ<span style="color:red;">(*)</span></label>
                            <input name="name" type="text" class="form-control" id="name">
                            <input type="hidden" id="hiddenEditConcentrationID">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" class="form-control" rows="5" placeholder="" id="concentrationCreate"></textarea>
                        </div>
