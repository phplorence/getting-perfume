            ...
            <div class="modal-body">
                ...
                <form role="form" method="post" action="{{ route('admin.perfume.concentration.store') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea name="description" id="m_description" class="form-control" rows="3" placeholder=""></textarea>
                        </div>

                        <div class="form-group">
                            <h3 class="box-title">Thông tin chi tiết sản phẩm</h3>
                            <textarea id = "editor2"  name="detail" class="form-control" rows="5" id="m_comment"></textarea>
                        </div>
