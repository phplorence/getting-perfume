                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.super.detail', $concentration->id) }}"><img src="{{URL::asset('img/icon-control/icon_edit.svg')}}"  width="24px" height="24px" alt="Update Icon"></a>
                                        <a href="{{ route('admin.super.delete', $concentration->id) }}"><img src="{{URL::asset('img/icon-control/icon_delete.svg')}}" width="24px" height="24px" alt="Delete Icon"></a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                </tbody>
                                ...
                                <form role="form" method="post" action="{{ route('admin.perfume.concentration.store') }}">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" id="i_name" placeholder="{{ old('name') }}">
                                            @if ($errors->has('name'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" id="i_link" placeholder="{{ old('link') }}">
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
                                    <div class="form-group">
