        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#revenue-chart" data-toggle="tab">Vị trí</a></li>
              <li><a href="#sales-chart" data-toggle="tab">Nước hoa</a></li>
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">Hổ trợ Online</h3>
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('img/user4-128x128.jpg')}}" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('img/user3-128x128.jpg')}}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{URL::asset('img/user2-160x160.jpg')}}" alt="user image" class="offline">
